    ...
    <main>
        ...
        <section class="promo-offers" id="promo-offers">
            <div class="offer-card">
                ...
                <a href="product-selection.html" class="btn">Shop Now</a>
            </div>
        ...
        <div class="promotion-section" id="promotion-section">
            ...
            <ol class="ordered-list">
                <li><strong>Sign Up for Our <a href="registration.html" target="_blank">Membership</a></strong> - Create a membership to receive exclusive offers and update.</li>
            ...
            <div class="ShopNow">
                <a class="info-button" href="product-selection.html">Shop Now</a>
            </div>
        </div>
